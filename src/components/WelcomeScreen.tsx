...
function SuitcaseLogo() {
  return (
    <svg className="welcome-logo" viewBox="0 0 96 96" fill="none" aria-hidden>
      <rect x="18" y="30" width="60" height="44" rx="10" stroke="currentColor" strokeWidth="2" />
      <path
        ...
        strokeLinecap="round"
      />
      <rect x="18" y="38" width="60" height="4" fill="currentColor" opacity="0.15" />
      <line x1="48" y1="42" x2="48" y2="70" stroke="currentColor" strokeWidth="1.5" opacity="0.15" />
      <rect x="40" y="22" width="16" height="6" rx="3" fill="currentColor" opacity="0.4" />
    </svg>
  );
}
